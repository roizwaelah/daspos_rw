...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.VH> {
    ...
    public UserAdapter(Listener listener) { this.listener = listener; }
    public void submit(List<User> users) { items.clear(); if (users != null) items.addAll(users); notifyDataSetChanged(); }
    ...
    @Override public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) { listener.onClick(user); }
        });
    }
